...
(define tests
  (test-suite
   ...
   (check-equal? (stream-for-n-steps dan-then-dog 7) (list "dan.jpg" "dog.jpg" "dan.jpg" "dog.jpg" "dan.jpg" "dog.jpg" "dan.jpg") "dan-then-dog test")
   
   ; stream-add-zero test
   (check-equal? (stream-for-n-steps (stream-add-zero ones) 1) (list (cons 0 1)) "stream-add-zero test")
   (check-equal? (stream-for-n-steps (stream-add-zero nats) 4) (list (cons 0 1) (cons 0 2) (cons 0 3) (cons 0 4)) "stream-add-zero test")
