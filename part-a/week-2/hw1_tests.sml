...
val test13_1 = ((is_leap_year 1600) andalso
                (is_leap_year 1988) andalso
                (is_leap_year 1992) andalso
                (is_leap_year 1996) andalso
                (is_leap_year 2040)) = true

val test13_2 = ((is_leap_year 1700) orelse
                (is_leap_year 1900) orelse
                (is_leap_year 2100) orelse
                (is_leap_year 2300) orelse
                (is_leap_year 1999) orelse
                (is_leap_year 2500)) = false
